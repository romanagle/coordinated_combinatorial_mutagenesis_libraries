...
generalizes to different evaluation library types (Type 2 vs Pairwise).

X-axis: SSM | Additive | Additive+Pairwise | Nonlinear Additive | Nonlin Add+Pairwise
Two bars per model:
  - Blue  = Type 2 eval library
...
saturated format (run mRNA_RBP/lib_size_spearman.py to populate/migrate).
