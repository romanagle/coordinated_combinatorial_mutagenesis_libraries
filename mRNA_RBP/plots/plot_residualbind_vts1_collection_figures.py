...
under pipeline_workspace/instance_00.
"""
...
def save_distribution_figures(cache):
    ...
    fig.savefig(FIG_DIR / "library_distributions.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
    ...
    fig.savefig(FIG_DIR / "activity_balanced_lib_dist.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
    ...
    fig.savefig(FIG_DIR / "type3_lib_dist.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
...
def save_pairwise_heatmaps(cache):
    ...
    fig.savefig(FIG_DIR / "pairwise_heatmaps_annotated.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
