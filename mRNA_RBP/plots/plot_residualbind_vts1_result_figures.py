...
pipeline_workspace/lib_size_spearman_results.json.
"""
...
def save_rho_vs_libsize(cache):
    ...
    fig.savefig(FIG_DIR / "rho_vs_libsize_type3.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
...
def save_model_comparison(cache):
    ...
    fig.savefig(FIG_DIR / "model_comparison_bar_type3.png", dpi=150, bbox_inches="tight")
    plt.close(fig)
