...
Figures are in `figures/`; copied cache/model/weight artifacts are in `libraries_used_for_figures/`. Built end-to-end by `mRNA_RBP/scripts/pipeline/build_ground_truth_collection.py --oracle deepsquid_vts1`. The manifest records every file included.
...
|---|---|---|---|---|---|
| `deepsquid_vts1_high` | 0.5611 | 0.2799 | 0.5611 | 0.2799 | — |
| `deepsquid_vts1_low` | 0.9203 | 0.4253 | 0.9203 | 0.4253 | — |
