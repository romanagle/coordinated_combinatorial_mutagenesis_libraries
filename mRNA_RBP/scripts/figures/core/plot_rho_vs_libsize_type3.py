...
eval split. Reads from the separate
...
from mRNA_RBP.scripts.pipeline.generate_libraries import LIB_SIZES
...
def main(save_svg: bool = False, json_path=None, gt_key=None, out_dir=None):
    json_path = json_path or JSON_PATH
    gt_key = gt_key or GT_KEY
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", default=None,
                        help="Override lib_size_spearman results JSON (default: synthetic GT type3 cache)")
    parser.add_argument("--gt_key", default=None,
                        help="Override GT/oracle score key (default: nonlin_additive_pairwise)")
    parser.add_argument("--out_dir", default=None,
                        help="Override output directory (default: outputs/notebook_plots)")
    args = parser.parse_args()
    main(save_svg=args.svg, json_path=args.json_path, gt_key=args.gt_key, out_dir=args.out_dir)
