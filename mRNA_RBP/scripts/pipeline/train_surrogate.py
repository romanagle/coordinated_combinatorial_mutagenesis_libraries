"""
mRNA_RBP/scripts/pipeline/train_surrogate.py
...
Run with the squid conda environment:
  /home/nagle/miniconda3/envs/squid/bin/python3.7 mRNA_RBP/scripts/pipeline/train_surrogate.py

Usage:
    python mRNA_RBP/scripts/pipeline/train_surrogate.py
    python mRNA_RBP/scripts/pipeline/train_surrogate.py --n_instances 1 --lib_sizes 20000
"""
...
from mRNA_RBP.src.evaluate import make_pairwise_dataset, make_ssm_deltas, predict_ssm
