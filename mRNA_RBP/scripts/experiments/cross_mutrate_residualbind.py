...
scoring:
    ...
    /home/nagle/miniconda3/envs/squid/bin/python3.7 \
        mRNA_RBP/scripts/experiments/cross_mutrate_residualbind.py --oracle vts1
...
from mRNA_RBP.src.oracles import default_output_base, normalize_oracle_name, primary_gt_key
