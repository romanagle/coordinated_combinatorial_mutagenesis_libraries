...
Scatter plot of SSM predictions vs GT scores on the activity-balanced and Pairwise
...
def main():
    ...
    print(f"Activity-balanced   ρ={rho_t2:.3f}  R²={r2_t2:.3f}  N={len(y_gt_t2):,}")
    ...
    panels = [
        (axes[0], y_gt_t2, y_ssm_t2, rho_t2, r2_t2, COLOR_T2, "Activity-balanced library"),
