...
x_mut = np.concatenate([x_mut_l, np.broadcast_to(no_padding_seq_motif, (lib_size, seq_length_m, 4)), np.broadcast_to(no_padding_seq_right, (lib_size, seq_length_r, 4))], axis=1)
...
# save the figure
plt.savefig("/home/nagle/final_version/output/1tail_mut_preds.png")