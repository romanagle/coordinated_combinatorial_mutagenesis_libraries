...
> Snapshot archived 2026-08-03 from `mRNA_RBP/NARRATIVE.md` at commit `0b22d857`.
...
- Hole review is paused at Section 3.
- Next decision: use separate exact mutation-order strata or pool n = 2, 3, 4, ... variants in the redesigned targeted-pairwise evaluation.
